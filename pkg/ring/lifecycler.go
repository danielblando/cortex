...
func (i *Lifecycler) GetInstanceID() string {
	return i.ID
}

// GetInstanceAddr returns the instance address.
func (i *Lifecycler) GetInstanceAddr() string {
	return i.Addr
}

// IsRegistered returns whether the instance is registered in the ring.
func (i *Lifecycler) IsRegistered() (bool, error) {
	...
	_, exists := ringDesc.Ingesters[i.ID]
	return exists, nil
}
